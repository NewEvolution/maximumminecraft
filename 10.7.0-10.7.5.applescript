...
on enableServiceShortcut()
  ...
  tell application "System Events"
    ...
    set focused of text field of last row of outline 1 of scroll area 2 of splitter group 1 of tab group 1 of window "Keyboard" of process "System Preferences" to true
  end tell
...
on disableTwoFingerScrolling()
  ...
  tell application "System Events"
    click radio button "Mouse & Trackpad" of tab group 1 of window "Universal Access" of process "System Preferences"
    click button "Trackpad Options..." of tab group 1 of window "Universal Access" of process "System Preferences"
    if value of checkbox "Scrolling" of sheet 1 of window "Universal Access" of process "System Preferences" is 1 then
      set announceIt to true
      click checkbox "Scrolling" of sheet 1 of window "Universal Access" of process "System Preferences"
    else
      set announceIt to false
    end if
    click button "Done" of sheet 1 of window "Universal Access" of process "System Preferences"
  end tell
  return announceIt
...
on enableTwoFingerScrolling()
  ...
  tell application "System Events"
    click radio button "Mouse & Trackpad" of tab group 1 of window "Universal Access" of process "System Preferences"
    click button "Trackpad Options..." of tab group 1 of window "Universal Access" of process "System Preferences"
    if value of checkbox "Scrolling" of sheet 1 of window "Universal Access" of process "System Preferences" is 0 then
      set announceIt to true
      click checkbox "Scrolling" of sheet 1 of window "Universal Access" of process "System Preferences"
    else
      set announceIt to false
